...
Compiler.prototype.calculateDirectories = function() {
  ...
  if (this.platform === 'android') {
    ...
    this.compiledApp += '/' + this.configuration + '-' + this.iosSdk + '/testtest.app';
  }

  this.zippedApp = this.appDirectory;
  if (this.platform === 'android') {
    this.zippedApp += '/testtest_android.apk';
  }
  else {
    this.zippedApp += '/testtest_ios.zip';
  }
};
...
Compiler.prototype.buildIos = function() {
  ...
  to_run += " -workspace " + this.platformDirectory + "/testtest.xcworkspace";
